...
public class CommonBase {
	...
	public static String reportpath1 = System.getProperty("user.dir") + System.getProperty("file.separator")
			+ "test-output" + System.getProperty("file.separator") + "TestReport.xlsx";
	public static String reportpath2 = System.getProperty("user.dir") + System.getProperty("file.separator")
			+ "test-output" + System.getProperty("file.separator") + "Extent.html";
	public static String reportpath3 = System.getProperty("user.dir") + System.getProperty("file.separator")
			+ "src/main/java/com/compgoparts/test/data" + System.getProperty("file.separator")
			+ "CompGoParts Scenarios.xlsx";
	...
	public WebDriver initDriver(String url, String browser) throws Exception {
		...
		if (browser.equalsIgnoreCase("ie") || browser.equalsIgnoreCase("internet explorer")) {
			...
			// This will move the mouse pointer to the location where the operation is being
			// performed on screen.
			 ...
			 * capabilities.setCapability("marionette", false); System.setProperty(
			 * "webdriver.gecko.driver", System.getProperty("user.dir") +
			 * System.getProperty("file.separator") + "BrowserDrivers" +
			...
			// Set logging preference In Google Chrome browser capability to log browser
			// errors.
			...
			System.setProperty("webdriver.safari.driver",
					System.getProperty("user.dir") + System.getProperty("file.separator") + "BrowserDrivers"
							+ System.getProperty("file.separator") + "SafariDriver.safariextz ");
			...
			System.setProperty("webdriver.edge.driver",
					System.getProperty("user.dir") + System.getProperty("file.separator") + "BrowserDrivers"
							+ System.getProperty("file.separator") + "MicrosoftWebDriver.exe ");
	...
	public static Capabilities FirefoxDriverProfile() throws Exception {
		 ...
		 * "about:blank"); profile.setPreference("startup.homepage_welcome_url",
		 * "about:blank");
		 */
	...
	public boolean isElementExist(WebElement elementName) {
	...
	public void browsername() {
		 ...
		 * System.out.println("Operating System "+os); String version =
		 * cap.getVersion().toString(); System.out.println("Version is "+version);
		 */
	...
	public static void emailreport() throws Exception {
		sendPDFReportByGMail("seleniumautomatonreports@gmail.com", "1111111!", "mani6747@gmail.com",
				"Elop Super Admin Automation Report", "");
	}
	...
	public static void fileupload(String string) {
		...
		StringSelection stringSelection = new StringSelection(string);//// StringSelection is a class that can be used
																		//// for copy and paste operations.
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(stringSelection, null);// When you do a cut or copy
																							// of text in the operating
																							// system, the text is
	...
	public static void HighLightElement(WebElement element) {
		...
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid orange;');",
				element);
	...
	public void slider(WebElement elementTodrag, int xOffset, int yOffset) {
		try {
			...
			System.out.println(
					"Element with " + elementTodrag + "is not attached to the page document " + e.getStackTrace());
		} catch (NoSuchElementException e) {
	...
	public String gettingEmailrandomly() throws Exception {
		...
		for (int i = 0; i < 1; i++) {
			...
			// String alpha2 = CommonBase.generateRandomStringemail(1,
			// CommonBase.ModeEmail.ALPHA);
			// String numeric1 =
			// CommonBase.generateRandomStringemail(2,CommonBase.ModeEmail.NUMERIC);
			// String alpha3 = CommonBase.generateRandomStringemail(1,
			// CommonBase.ModeEmail.ALPHA);
			// String numeric2 =
			// CommonBase.generateRandomStringemail(3,CommonBase.ModeEmail.NUMERIC);
			// String alpha4 = CommonBase.generateRandomStringemail(1,
			// CommonBase.ModeEmail.ALPHA);
			// randomemail =
			// alpha.concat(numeric).concat(alpha2).concat(numeric1).concat(alpha3).concat(numeric2).concat(alpha4).concat("@gmail.com");
